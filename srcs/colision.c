...
/*   Updated: 2025/08/08 20:09:33 by pedro            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int colision_top(t_game *game)
{
    ...
    if (game->map.coordinate[px_limit][px_left] == '1' || game->map.coordinate[px_limit][px_right] == '1')
        return (0);
    return (1);
}
...
static int colision_left(t_game *game)
{
    ...
    if (game->map.coordinate[px_top][px_limit] == '1' || game->map.coordinate[px_down][px_limit] == '1')
        return (0);
    return (1);
}
