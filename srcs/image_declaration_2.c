...
static void	number_img_2(t_game *game)
{
	...
	game->sprite->numbers[8] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/08_bold.xpm", &game->sprite->w,
			&game->sprite->h);
	game->sprite->numbers[9] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/09_bold.xpm", &game->sprite->w,
			&game->sprite->h);
...
void	numbers_img_declaration(t_game *game)
{
	...
	game->sprite->numbers[1] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/01_bold.xpm", &game->sprite->w,
			&game->sprite->h);
	game->sprite->numbers[2] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/02_bold.xpm", &game->sprite->w,
			&game->sprite->h);
	game->sprite->numbers[3] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/03_bold.xpm", &game->sprite->w,
			&game->sprite->h);
	game->sprite->numbers[4] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/04_bold.xpm", &game->sprite->w,
			&game->sprite->h);
	game->sprite->numbers[5] = mlx_xpm_file_to_image(game->mlx,
			"imgs/assets/steps_&_numbers/05_bold.xpm", &game->sprite->w,
			&game->sprite->h);
